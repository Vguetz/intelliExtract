        ...
        <>
            <MaxWidthWrapper className="mb-8 mt-24 text-center max-w-5xl" >
                <div className="mx-auto mb-10 sm:max-w-lg" >
                    <h1 className="text-6xl font-bold sm:font-7xl">Pricing</h1>
                        ...
                        {pricingItems.map(({ plan, tagline, quota, features }) => {
                            ...
                            return (
                                <div key={plan} className={cn("relative rounded-2xl bg-white shadow-lg", {
                                    "border-2 border-pink-700 shadow-pink-300": plan === "Pro",
                                    "border border-gray-200": plan !== "Pro"
                                })}>
                                    {plan === "Pro" && (
                                        <div className="absolute -top-5 left-0 right-0 mx-auto w-32 rounded-full bg-gradient-to-r from-pink-600 to-violet-400 px-3 py-2 text-sm font-medium text-white" >
                                            Upgrade now.
                                        </div>
                                    )}
                                    <div className="p-5" >
                                    ...
                                    <div className="flex h-20 items-center justify-center border-b border-t border-gray-200 bg-gray-50" >
                                        <div className="flex items-center space-x-1" >
                                            <p className="" >{quota.toLocaleString()} PDFs/mo included </p>
