...
import { ChevronDownIcon, ChevronUp, Loader2, RotateCw, Search } from "lucide-react"
        ...
        <div className="w-full bg-white rounded-md shadow flex flex-col items-center">
            {/* top bar */}<div className="h-14 w-full border-b border-zinc-200 flex items-center justify-between px-2">
                <div className="flex items-center gap-1.5" >
                    ...
                    <div className="flex items-center gap-1.5" >
                        <Input {...register("page")} className={cn('w-12 h-8', errors.page && "focus-visible:ring-red-300")} onKeyDown={(e) => {
                            if (e.key === "Enter") {
                    ...
                    }} variant='ghost' aria-label='next page'><ChevronUp className="h-4 w-4" /></Button>
                </div>
